...
public class MPGuiMargin {
    ...
    public MPGuiMargin(float all) { left = top = right = bottom = all; }

    public MPGuiMargin(float horizontal, float vertical) {
        left = right = horizontal;
        top = bottom = vertical;
    }

    public MPGuiMargin(float left, float top, float right, float bottom) {
        this.left = left;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
