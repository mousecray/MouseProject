...
public class MPGuiEventFactory {
    ...
    public static <T extends MPGuiElement<T>> void pushMouseMoveEvent(MPGuiMouseMoveEvent<T> event, int x, int y, MoveDirection moveDirection) {
        event.reset();
        event.setMouseX(x);
        event.setMouseY(y);
    ...
    public static <T extends MPGuiElement<T>> void pushMouseScrollEvent(MPGuiMouseScrollEvent<T> event, int x, int y, ScrollDirection scrollDirection, int scrollAmount) {
        event.reset();
        event.setMouseX(x);
        event.setMouseY(y);
    ...
    public static <T extends MPGuiElement<T>> void pushMouseDragEvent(MPGuiMouseDragEvent<T> event, int x, int y, MoveDirection moveDirection, int diffX, int diffY, int tickDown) {
        event.reset();
        event.setMouseX(x);
        event.setMouseY(y);
        event.setMoveDirection(moveDirection);
    ...
    public static <T extends MPGuiElement<T>> void pushSoundEvent(MPGuiSoundEvent<T> event, int x, int y, SoundHandler handler, SoundEvent sound, SoundSourceType source) {
        event.reset();
        event.setMouseX(x);
        event.setMouseY(y);
